 ...
 * 
 * This service provides both blocking and reactive methods.
 * Reactive methods wrap blocking operations using Schedulers.boundedElastic().
 */
@Service
public class Neo4jGraphService {
    ...
    // These methods wrap blocking operations in Mono using Schedulers.boundedElastic()

    public Mono<String> createNodeReactive(String label, Map<String, Object> properties) {
        return Mono.fromCallable(() -> createNode(label, properties))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> deleteNodeReactive(String label, String propertyKey, String propertyValue) {
        return Mono.fromCallable(() -> deleteNode(label, propertyKey, propertyValue))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> findNodeReactive(String label, String propertyKey, String propertyValue, Integer limit) {
        return Mono.fromCallable(() -> findNode(label, propertyKey, propertyValue, limit))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> updateNodeReactive(String label, String propertyKey, String propertyValue, Map<String, Object> properties) {
        return Mono.fromCallable(() -> updateNode(label, propertyKey, propertyValue, properties))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> createRelationshipReactive(String startLabel, String startKey, String startValue,
                                                    String endLabel, String endKey, String endValue,
                                                    String type, Map<String, Object> properties) {
        return Mono.fromCallable(() -> createRelationship(startLabel, startKey, startValue, endLabel, endKey, endValue, type, properties))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> deleteRelationshipReactive(String startLabel, String startKey, String startValue,
                                                    String endLabel, String endKey, String endValue, String type) {
        return Mono.fromCallable(() -> deleteRelationship(startLabel, startKey, startValue, endLabel, endKey, endValue, type))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> findRelationshipReactive(String startLabel, String startKey, String startValue,
                                                  String endLabel, String endKey, String endValue,
                                                  String type, Integer limit) {
        return Mono.fromCallable(() -> findRelationship(startLabel, startKey, startValue, endLabel, endKey, endValue, type, limit))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> updateRelationshipReactive(String startLabel, String startKey, String startValue,
                                                    String endLabel, String endKey, String endValue,
                                                    String type, Map<String, Object> properties) {
        return Mono.fromCallable(() -> updateRelationship(startLabel, startKey, startValue, endLabel, endKey, endValue, type, properties))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> findPathReactive(String startLabel, String startKey, String startValue,
                                         String endLabel, String endKey, String endValue,
                                         String relationshipType, Integer maxDepth, Boolean shortestOnly) {
        return Mono.fromCallable(() -> findPath(startLabel, startKey, startValue, endLabel, endKey, endValue, relationshipType, maxDepth, shortestOnly))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> findNeighborsReactive(String label, String propertyKey, String propertyValue,
                                              String relationshipType, Integer limit) {
        return Mono.fromCallable(() -> findNeighbors(label, propertyKey, propertyValue, relationshipType, limit))
                .subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<String> fuzzySearchReactive(String label, String propertyKey, String searchValue,
                                            Boolean useRegex, Integer limit) {
        return Mono.fromCallable(() -> fuzzySearch(label, propertyKey, searchValue, useRegex, limit))
                .subscribeOn(Schedulers.boundedElastic());
    }
}
