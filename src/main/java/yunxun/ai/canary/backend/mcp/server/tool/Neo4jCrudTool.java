...
public class Neo4jCrudTool {
    ...
    public String createNode(
        ...
        return graphService.createNodeReactive(label, properties)
    ...
    public String deleteNode(
        ...
        return graphService.deleteNodeReactive(label, propertyKey, propertyValue)
                .block(java.time.Duration.ofSeconds(10));
    }
    ...
    public String findNode(
        ...
        return graphService.findNodeReactive(label, propertyKey, propertyValue, limit)
                .block(java.time.Duration.ofSeconds(10));
    }
    ...
    public String updateNode(
        ...
        return graphService.updateNodeReactive(label, propertyKey, propertyValue, properties)
                .block(java.time.Duration.ofSeconds(10));
    }
    ...
    public String createRelationship(
        ...
        return graphService.createRelationshipReactive(startLabel, startKey, startValue,
    ...
    public String deleteRelationship(
        ...
        return graphService.deleteRelationshipReactive(startLabel, startKey, startValue,
    ...
    public String findRelationship(
        ...
        return graphService.findRelationshipReactive(startLabel, startKey, startValue,
    ...
    public String updateRelationship(
        ...
        return graphService.updateRelationshipReactive(startLabel, startKey, startValue,
                endLabel, endKey, endValue, type, properties)
                .block(java.time.Duration.ofSeconds(10));
    }
    ...
    public String findPath(
        ...
        return graphService.findPathReactive(startLabel, startKey, startValue,
    ...
    public String findNeighbors(
        ...
        return graphService.findNeighborsReactive(label, propertyKey, propertyValue, relationshipType, limit)
                .block(java.time.Duration.ofSeconds(10));
    }
    ...
    public String fuzzySearch(
            ...
            @ToolParam(description = "返回节点的最大数量") Integer limit) {
        return graphService.fuzzySearchReactive(label, propertyKey, searchValue, useRegex, limit)
                .block(java.time.Duration.ofSeconds(10));
    }
}
